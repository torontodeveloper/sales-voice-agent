...
save_json_data("./data/splits/training_data.jsonl", shared_gpt_train_data)
save_json_data("./data/splits/validation_data.jsonl", shared_gpt_validation_data)
save_json_data("./data/splits/test_data.jsonl", shared_gpt_test_data)
